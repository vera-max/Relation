...
final class SubjectController extends AbstractController
{
    ...
    #[Route('/subjects', name: 'subject_all', methods:['GET'])]
    public function getAll(): Response
    {
        $subject = $this->entityManager->getRepository(Subject::class);
       return $this->json($subject->findAll());
    }
     #[Route('/subjects', name: 'subject_delete', methods:['DELETE'])]
    public function delete( string $id): JsonResponse
    {
     ...
     #[Route('/subjects', name: 'subject_create', methods:['POST'])]
    public function create( #[MapRequestPayload] SubjectDto  $payload): JsonResponse
   {
     ...
     #[Route('/subjects/{id}', name: 'subject_edit', methods:['PUT'])]
...
#[Route('/subjects/{id}', name: 'subject', methods:['GET'])]
